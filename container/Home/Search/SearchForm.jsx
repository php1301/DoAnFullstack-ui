  ...
  return (
    <FormWrapper>
      <ComponentWrapper>
        ...
        <label for="map_autocomplete_input">­­  ­</label>
      </ComponentWrapper>
        ...
        <ViewWithPopup
          ...
          view={(
            <Button type="default">
              <span>
                Room
                {roomGuest.room > 0 && `: ${roomGuest.room}`}
              </span>
              <span>-</span>
              <span>
                Guest
                {roomGuest.guest > 0 && `: ${roomGuest.guest}`}
              </span>
            </Button>
          )}
          popup={(
