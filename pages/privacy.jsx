const Privacy = () => (
  <div>
    ...
    <p>
      ...
      <b>“Terms”</b>
      ) govern all use of our Service and
    ...
    <p>
      <b>SERVICE</b>
      {' '}
      means the palacetripfinder.com website operated by UIT.
    </p>
    <p>
      <b>PERSONAL DATA</b>
      {' '}
    ...
    <p>
      ...
      information such as the type of device you use, your device unique ID, the
      IP address of your device, your device operating system, the type of
    ...
    <p>
      ...
      {' '}
      Advertising Cookies are used to serve you
    ...
    <p>UIT uses the collected data for various purposes:</p>
    ...
    <p>
      If you are located outside Vietnam and choose to provide information to us,
      please note that we transfer the data, including Personal Data, to Vietnam
    ...
    <p>
      UIT will take all the steps reasonably necessary to ensure that your data is
    ...
    <p>
      ...
      copy of your Personal Data in a structured, machine-readable and commonly
      used format;
    </p>
    <p>
    ...
    <p>
      ...
      for the California Consumer Privacy Act. To find out more, visit the
      official California Legislative Information website. The CCPA took effect on
      01/01/2020.
    </p>
    <p>
      13.
    ...
    <p>
      ...
      , a free tool
      that helps create high-quality legal documents. PolicyMaker’s
      {' '}
